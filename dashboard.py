...
latest = {"temp": 0, "humidity": 0, "pressure": 0}

def read_sensor():
    while True:
        latest["temp"] = round(bme280.temperature, 1)
        latest["humidity"] = round(bme280.relative_humidity, 1)
        latest["pressure"] = round(bme280.pressure, 1)
        time.sleep(5)
